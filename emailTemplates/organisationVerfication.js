...
const organisationVerfication  = (token) => {
  ...
  <body>
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <p style="color: #666;">Dear [Organization Name],</p>
      ...
      <p style="color: #666;">Alternatively, you can use the following verification code: <strong>[Verification Code]</strong></p>
